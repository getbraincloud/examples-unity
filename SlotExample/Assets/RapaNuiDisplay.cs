...
{
    public class RapaNuiDisplay : MonoBehaviour
    {
        ...
        void Start()
        {
            m_progressiveJackpot = GameObject.Find("BrainCloudStats").GetComponent<BrainCloudStats>().m_progressiveJackpot;
            m_balance = GameObject.Find("BrainCloudStats").GetComponent<BrainCloudStats>().m_credits;
            ...
            m_slotImages.Add(-1, Resources.Load<Sprite>("RN_Symbol_04"));
            m_slotImages.Add(-2, Resources.Load<Sprite>("RN_Symbol_05"));
            m_slotImages.Add(9, Resources.Load<Sprite>("RN_Symbol_06"));
            m_slotImages.Add(10, Resources.Load<Sprite>("RN_Symbol_07"));
            m_slotImages.Add(11, Resources.Load<Sprite>("RN_Symbol_08"));
            m_slotImages.Add(12, Resources.Load<Sprite>("RN_Symbol_09"));
            m_slotImages.Add(13, Resources.Load<Sprite>("RN_Symbol_03"));
            m_slotImages.Add(14, Resources.Load<Sprite>("RN_Symbol_01"));
            m_slotImages.Add(15, Resources.Load<Sprite>("RN_Symbol_02"));
        }
        ...
        void Update()
        {
            ...
            m_displayedSymbols[0] = GetComponent<RapaNuiController>().GetSymbols(0);
            m_displayedSymbols[1] = GetComponent<RapaNuiController>().GetSymbols(1);
            m_displayedSymbols[2] = GetComponent<RapaNuiController>().GetSymbols(2);
            m_displayedSymbols[3] = GetComponent<RapaNuiController>().GetSymbols(3);
            m_displayedSymbols[4] = GetComponent<RapaNuiController>().GetSymbols(4);
        ...
        IEnumerator StopSpinning(int aReel, bool aAuto)
        {
            ...
            if (aReel == 4)
            {
                ...
                GetComponent<RapaNuiController>().FinishSpinning();
        ...
        public void StopAllReels()
        {
            ...
            {
                m_isAuto = false;
                GetComponent<RapaNuiController>().StopAutoPlay();
            }
            m_spinButton.image.sprite = m_spinButtonSprite;
            StopAllCoroutines();
        ...
        public void SetLastWin(int aLastWin)
        {
            ...
            {
                GameObject.Find("DialogDisplay").GetComponent<RapaNuiDialogDisplay>().CreateBigWinDialog(aLastWin.ToString("C0", new System.Globalization.CultureInfo("en-us")), 2.6f);
            }
        }
    }
}