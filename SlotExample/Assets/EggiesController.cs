...
namespace BrainCloudSlots.Eggies
{
    ...
    public class EggiesController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_slotData = GameObject.Find("BrainCloudStats").GetComponent<BrainCloudStats>().m_slotsDataEggies;
        ...
        {
            GameObject.Find("BrainCloudStats").GetComponent<BrainCloudStats>().m_showOffersPage = true;
        ...
        public void GetSlotsResponse(string responseData, object cbObject)
        {
            ...
            GameObject.Find("BrainCloudStats").GetComponent<BrainCloudStats>().m_credits = m_newBalance;
            GameObject.Find("BrainCloudStats").GetComponent<BrainCloudStats>().m_progressiveJackpot = int.Parse(response["updatedProgressiveJackpot"].ToString());
