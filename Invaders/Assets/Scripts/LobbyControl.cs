...
public class LobbyControl : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        Debug.Log("NetworkSpawn for Lobby Control");
    ...
    {
        Debug.Log("Number Of Clients in lobby: " + m_ClientsInLobby.Count);
        Debug.Log("Minimum Player Count: " + m_MinimumPlayerCount);
        ...
        if (m_AllPlayersInLobby)
        {
            ...
            foreach (var clientLobbyStatus in m_ClientsInLobby)
                if (!clientLobbyStatus.Value)
                {
                    ...
                    Debug.Log("Client ID not ready: " + clientLobbyStatus.Key);
                }

            //Only if all players are ready
            if (allPlayersAreReady)
            {
                Debug.Log("All Players ready, moving to game scene...");
