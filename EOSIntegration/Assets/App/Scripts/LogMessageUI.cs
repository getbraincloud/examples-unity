...
public class LogMessageUI : MonoBehaviour
{
    ...
    [SerializeField] private ContentSizeFitter LogSizeFitter = default;
    ...
    {
        get => LogText.textWrappingMode == TextWrappingModes.Normal || LogText.textWrappingMode == TextWrappingModes.PreserveWhitespace;
    ...
    public void ConfigureLogObject(LogType type, string message, bool wordWrap, bool canCopy)
    {
        Text = message;
        SetLogType(type);
        WordWrapText = wordWrap;// ? TextWrappingModes.Normal : TextWrappingModes.NoWrap;
        CanCopyText = canCopy;
        LogSizeFitter.horizontalFit = wordWrap ? ContentSizeFitter.FitMode.Unconstrained : ContentSizeFitter.FitMode.PreferredSize;
    }
