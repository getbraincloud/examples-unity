...
namespace AssetBundles
{
    public class BuildScript
    {
        ...
        public static void BuildAssetBundles(BuildTarget in_buildTarget)
        {
            // Choose the output path according to the build target.
            ...
            */
            ...
            BuildPipeline.BuildAssetBundles(outputPath, options, in_buildTarget);
        }

        public static void RebuildBuildAssetBundles(BuildTarget in_buildTarget)
        {
            // Choose the output path according to the build target.
            string outputPath = CreateAssetBundleDirectory();
