...
{	
	...
	public class AssetBundleManager : MonoBehaviour
	{
        ...
        static public bool IsAssetBundleDownloading(string assetBundleName)
        {
            return m_DownloadingWWWs.Keys.ToList().Contains(assetBundleName);
        }

        public static bool IsDownloadingBundles() { return m_DownloadingWWWs.Count > 0; }
