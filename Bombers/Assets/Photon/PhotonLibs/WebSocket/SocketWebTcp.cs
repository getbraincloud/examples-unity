...
namespace ExitGames.Client.Photon
{
    ...
    public class SocketWebTcp : IPhotonSocket, IDisposable
    {
        ...
        public override bool Connect()
        {
            ...
            this.sock = new PhotonWebSocket(new Uri(this.ServerAddress), SerializationProtocol);          // TODO: The protocol should be set based on current PeerBase value (but that's currently not accessible)
            this.sock.Connect();
