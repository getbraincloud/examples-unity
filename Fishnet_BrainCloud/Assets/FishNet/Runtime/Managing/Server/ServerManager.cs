...
namespace FishNet.Managing.Server
{
    ...
    public sealed partial class ServerManager : MonoBehaviour
    {
        ...
        private void ParseVersion(PooledReader reader, NetworkConnection conn, int transportId)
        {
            ...
            Debug.Log("READING VERSION: " + version);
            //Version match.
        ...
        private void ParseReceived(ServerReceivedDataArgs args)
        {
            ...
            * received. */
            ...
            //packetId = reader.PeekAbsolutePacketId();

            //Parse reader.
            while (reader.Remaining > 0)
            {
                packetId = reader.ReadPacketId();
                //ushort shortVal = reader.ReadUInt16Unpacked();
#if DEVELOPMENT
                ...
                {
                    Debug.Log("Server kick connection not authenticated");
