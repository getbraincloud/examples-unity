...
public readonly struct PopupInfo
{
    ...
    /// </summary>
    public readonly bool HasTitle => !Title.IsEmpty();
    ...
    /// </summary>
    public readonly string DismissButtonText => AlternateDismissButtonText.IsEmpty() ? DEFAULT_DISMISS_TEXT : AlternateDismissButtonText;
